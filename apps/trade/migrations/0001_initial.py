...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_sn', models.CharField(max_length=30, unique=True, verbose_name='用户')),
                ('trade_no', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='交易编号')),
                ('page_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('cancel', '待支付')], max_length=10, verbose_name='订单状态')),
