...
#     category_type = models.CharField(choices=CATEGORY_TYPE, max_length=2,verbose_name="类目级别", help_text="类目级别")
...
#     品牌名
#     '''
#     category = models.ForeignKey(GoodsCategory,null=True,blank=True,on_delete=models.DO_NOTHING,verbose_name='商品类目')
...
#     goods_sn = models.CharField(max_length=50, default="", verbose_name="SN码")
...
#     goods_brief = models.TextField(max_length=500, null=True, blank=True, verbose_name="商品简述")
#     goods_desc = UEditorField(verbose_name=u"内容", imagePath="goods/images/", width=1000, height=300,
#                               filePath="goods/files/", default='')
#     ship_free = models.BooleanField(default=True, verbose_name='是否承担运费')
#     goods_front_image = models.ImageField(upload_to="", null=True, blank=True, verbose_name="封面图")
#     goods_front_image_url = models.CharField(max_length=300, default="", verbose_name="封面图")
...
#     goods = models.ForeignKey(Goods,on_delete=models.DO_NOTHING,related_name='goods')
#     add_time = models.DateTimeField(auto_now_add=True, verbose_name="添加时间")
#     update_time = models.DateTimeField(auto_now=True)
#
#     class Meta:
...
#     image = models.ImageField(upload_to="", null=True, blank=True, verbose_name="封面图")
#     image_url = models.CharField(max_length=300, null=True, blank=True, verbose_name="封面图")
#     add_time = models.DateTimeField(auto_now_add=True, verbose_name="添加时间")
#     update_time = models.DateTimeField(auto_now=True)
#
#     class Meta:
...
class GoodsCategoryBrand(models.Model):
    ...
    category = models.ForeignKey(GoodsCategory, related_name='brands', null=True, blank=True,
                    on_delete = models.DO_NOTHING,verbose_name="商品类目")
...
class IndexAd(models.Model):
    category = models.ForeignKey(GoodsCategory, related_name='category',verbose_name="商品类目", on_delete=models.DO_NOTHING)
    goods =models.ForeignKey(Goods, related_name='goods', on_delete=models.DO_NOTHING)
    add_time = models.DateTimeField(auto_now_add=True, verbose_name="添加时间")
    update_time = models.DateTimeField(auto_now=True)
    class Meta:
        verbose_name = '首页商品类别广告'
